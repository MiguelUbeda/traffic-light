...
const Semáforo = () => {
    ...
    <div class="container semáforo bg-dark d-grid justify-content-center">
        <div style={{boxShadow: color === "red" ? "0px 0px 4px 4px #DDDAAC" : 'none'}}class="red light bg-danger rounded-circle mt-" onClick={()=> color === "red" ? setColor("none") : setColor("red")}></div>
